const MESSAGES = {
  ...
  isMin: 'This field should be lower than %s.',
  isMax: 'This field should be higher than %s.',
  isBetween: 'This field should be betweem %s and %s.',
  isset: 'This field is required.',
  is_strict_equal: 'This field should be equals to %s.'
};
